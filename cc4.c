...
setcodes() {
  setseq();
/* BEGIN PDP8 */
  code[ADD12]   = "\211JMS I __add12\n";
  code[ADD1n]   = "\010JMS I __add1n\n? <n>? 0?\n";
  code[ADD21]   = "\211JMS I __add21\n";
  ...
  code[BYTEn]   = "\000  <n>\n";
  code[BYTEr0]  = "\000# 0\n#";
  code[COM1]    = "\010JMS I __com1\n";
  code[COMMAn]  = "\000 <n>\n"; /* second memory or immediate operand */
  code[DBL1]    = "\010JMS I __dbl1\n";
  code[DBL2]    = "\001JMS I __dbl2\n";
  code[DECbp]   = "\001JMS I __decbp\n";
  code[DECwp]   = "\001JMS I __decwp\n";
  code[DIV12]   = "\011JMS I __div\n";            /* see gen() */
  code[DIV12u]  = "\011JMS I __divu\n";           /* see gen() */
  code[ENTER]   = "\100JMS I __enter\n";
  ...
  code[GETb1p]  = "\021JMS I __getb1p\n? <n>? 0?\n"; /* see gen() */
  code[GETb1pu] = "\021JMS I __getb1pu\n? <n>? 0?\n"; /* see gen() */
  code[GETb1s]  = "\020JMS I __getb1s\n <n>\n";
  code[GETb1su] = "\020JMS I __getb1su\n <n>\n";
  code[GETw1m]  = "\020JMS I __getw1m\n <m>\n";
  code[GETw1m_] = "\020JMS I __getw1m\n <m>"; /* only with PLUSn! */
  code[GETw1n]  = "\020JMS I __getw1n\n <n>\n";
  code[GETw1p]  = "\021JMS I __getw1p\n? <n>? 0?\n"; /* see gen() */
  code[GETw1s]  = "\020JMS I __getw1s\n <n>\n";
  code[GETw2m]  = "\020JMS I __getw2m\n <m>\n";
  code[GETw2n]  = "\020JMS I __getw2n\n <n>\n";
  code[GETw2p]  = "\021JMS I __getw2p\n? <n>? 0?\n"; /* see gen() */
  code[GETw2s]  = "\020JMS I __getw2s\n? <n>? 0?\n";
  code[GT10f]   = "\010JMS I __gt10f\n _<n>\n";
  code[GT12]    = "\010JMS I __gt\n";
  code[GT12u]   = "\011JMS I __ugt\n";
  ...
  code[MOD12]   = "\011JMS I __mod\n";    /* see gen() */
  code[MOD12u]  = "\011JMS I __modu\n";   /* see gen() */
  code[MOVE21]  = "\012TAD _AX\nDCA _BX\n";
  code[MUL12]   = "\211JMS I __imul\n";
  code[MUL12u]  = "\211JMS I __umulu\n";
  code[NE10f]   = "\010JMS I __ne10f\n _<n>\n";
  code[NE12]    = "\211JMS __ne\n";
  code[NEARm]   = "\000  _<n>\n";
  code[OR12]    = "\211JMS I __or12\n";
  code[PLUSn]   = "\000?+<n>??\n"; /* Add to pointer operand */
  code[POINT1l] = "\020JMS I __point1l\n _<l>+<n>\n";
  code[POINT1m] = "\020JMS I __point1m\n <m>\n";
  code[POINT1s] = "\020JMS I __point1s\n <n>\n";
  code[POINT2m] = "\002JMS I __point2m\n <m>\n";
  code[POINT2m_]= "\002JMS I __point2m\n <m>"; /* only with PLUSn! */
  code[POINT2s] = "\002JMS I __point2s\n <n>\n";
  code[POP2]    = "\002JMS I __pop2\n";
  code[PUSH1]   = "\110JMS I __push1\n";
  code[PUSH2]   = "\101JMS I __push2\n";
  code[PUSHm]   = "\100JMS I __pushm\n <m>\n";
  code[PUSHp]   = "\100JMS I __pushp\n? <n>? 0?\n";
  code[PUSHs]   = "\100JMS I __pushs\n? <n>? 0?\n";
  code[PUT_m_]  = "\000JMS I __put_m\n <m>\n"; /* only with COMMAn! */
  code[PUTbm1]  = "\010JMS I __putbm1\n <m>\n";
  code[PUTbp1]  = "\011TAD _AX\nDCA I _BX\n";
  code[PUTwm1]  = "\010JMS I __putwm1\n <m>\n";
  code[PUTwp1]  = "\011TAD _AX\nDCA I _BX\n";
  code[rDEC1]   = "\010#JMS I __rdec1\n#";
  code[rDEC2]   = "\010#JMS I __rdec2\n#";
  code[REFm]    = "\000_<n>,"; /* Label for data */
  code[RETURN]  = "\000?JMP I __return\n?JMP I __rets\n?";
  code[rINC1]   = "\010#ISZ _AX\nNOP\n#";
  code[rINC2]   = "\010#ISZ _BX\nNOP\n#";
  code[SUB_m_]  = "\000JMS I __sub_m\n <m>\n"; /* only with COMMAn! */
  code[SUB12]   = "\011JMS I __sub12\n"; /* see gen() */
  code[SUB1n]   = "\010?JMS I __sub1n\n <n>\n??\n";
  code[SUBbpn]  = "\001JMS I __subbpn\n <n>\n";
